...
const Landing = () => {
  return (
    <div className="landing" id="landing">
      <ScrollTextLand
        word={"Join our Discord to contribute to our codebase!"}
      />

      <div className="land_cov">
        <div className="land_item1">
          <p className="hdy">
            Choice Coin: A Democratic<br /> Token Built For <br /> a New Age.
          </p>
          <p className="suby">
            Choice Coin is an Algorand Standard Asset (ASA) that powers the Choice Coin DAO, a Decentralized Autonomous Organization built on the Algorand Blockchain. The Choice Coin DAO aims to make decentralized voting a reality through allocations to open-source software development and community awareness. Currently, Choice Coin has developed Decentralized Decisions to handle governance within its own DAO.
            <br />
            <br />
        ...
        <h3>Rules</h3>
          ...
          1. One Choice is equal to one vote.
          2. You can vote as many times as you desire.
          3. There are no limits on how much Choice you can use to vote.
          4. Any Choice sent after the voting deadline, Wednesday December 29th at 5:00PM will not
              count, will not be rewarded, and will not be returned.
          5. All votes are final.
          </p>
        </div>
        <div className="land_item1">
        <h3>Rewards</h3>
