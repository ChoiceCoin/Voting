...
class AlgoExplorer(Scraper):
    ...
    def next_page(self):
        js_snippet = """nextBtn = document.querySelector("#__next > div > div.master > div.root > div > div:nth-child(3) > div > div > div > div > div:nth-child(1) > div.styles_pagination-container__i_fkI > button.styles_pagination-btn__vJnM4.styles_next__NxHpD.btn.btn-secondary");
        nextBtn.click();
        """
        base64_snippet = base64.b64encode(base64.b64encode(js_snippet.encode()).decode())
