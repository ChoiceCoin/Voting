...
def write_csv(all_data):
    ...
    with open("myFile3.csv", "w", encoding="UTF-8") as f:
        writer = csv.DictWriter(f, fieldnames=header)
        writer.writeheader()
        writer.writerows(all_data)
    print("Saved file to myFile3.csv")
...
#def next_page()
    #image = soup.find("button", class="styles_pagination-btn__vJnM4 styles_next__NxHpD btn btn-secondary")
    #link = image.parent
