...
const CreateAct = () => {
  ...
  const mnemonics =
    "cupboard excite beef wait include soda deal august put just pony tenant surge access license chicken category earth sketch album sand rival bid absent view";
