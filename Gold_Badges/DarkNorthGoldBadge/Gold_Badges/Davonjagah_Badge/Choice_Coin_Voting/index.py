...
app = Flask(__name__)
mysql = MySQL()
app.config['MYSQL_DAASE_USER'] = 'root'
app.config['MYSQL_DATABASE_PASSWORD'] = '12345_67890'
...
def start_voting():
	...
	if request.method == 'POST':
		...
		if key == 'bade935484e273138fa4c578b266d9401a7a6d42f5512534b5c533f8c7d9408bbfeb04daf7db31d745b5d7cbcd9cbbac811280b3aa554566b7407b4b8722e9ae':
			message = reset_votes()
			finished = False
		else:
...
def create():
	if request.method == 'POST':
		...
		Drivers = hashing(str(request.form.get('Drivers')))
		Key = hashing(str(request.form.get('Key')))
		if str(Key) == 'bade935484e273138fa4c578b266d9401a7a6d42f5512534b5c533f8c7d9408bbfeb04daf7db31d745b5d7cbcd9cbbac811280b3aa554566b7407b4b8722e9ae':
