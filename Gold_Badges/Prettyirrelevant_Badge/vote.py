...
def election_voting(candidate):
    """Cast a vote for candidate."""
    transaction_id = choice_vote(
    ...
    return f"Ballot tabulated. You can validate that your vote was counted correctly at https://testnet.algoexplorer.io/tx/{transaction_id[1]}/"
...
#         Q = secrets.choice(quantum_sample)
#         if Q:
