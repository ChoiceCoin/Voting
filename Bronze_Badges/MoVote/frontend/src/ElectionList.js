  ...
  const election_data = [
    {
      ...
      card_desc:
        "The $Choice is yours. Choice Coin is a Decentralized Autonomous Organization (DAO) dedicated to decentralized governance. The goal for Choice Coin is to help solve the decentralized governance problem by leveraging the Algorand blockchain to build the world’s best voting technology. Vote 0 is the first vote for the Choice Coin DAO.",
      choice_per_vote: 1,
