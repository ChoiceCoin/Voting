...
def election_voting(vote):
    ...
    if vote == 'YES':  # Add more boolean statements for more decisions or candidates.
        ...
        message = 'https://testnet.algoexplorer.io/tx/'+TX_ID[1]
...
def show_corporate_results(yes_count, no_count):
    ...
    plt.savefig('/Choice_Coin_Voting/static/img/Figure_2.png')
...
def reset_votes():
    ...
    if yes_count > 0:
        transaction_2 = AssetTransferTxn(clawback_address, params, escrow_address, yes_count, choice_id,
    ...
    if no_count > 0:
        transaction_3 = AssetTransferTxn(clawback_address, params, escrow_address, no_count, choice_id,
