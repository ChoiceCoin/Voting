...
def contact_us():
    ...
    contact_email = request.form.get('mail')
    body = request.form.get('body')
    msg = f'email: {contact_email} \n message: {body}'
    message = Message(subject, sender='Choice Coin Voting', recipients=['example@mail.com'])
    message.body = msg
    mail.send(message)
    for_user = 'your response has been delivered to the admin'

    return render_template('index.html', message=for_user)
